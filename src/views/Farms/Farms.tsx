...
const Farms: React.FC<FarmsProps> = (farmsProps) => {
  ...
  return (
    <Page>
      <Heading as="h1" size="lg" color="primary" mb="50px" style={{ textAlign: 'center' ,fontFamily:"Helvetica"}}>
        {
          tokenMode ?
      ...
      <Heading as="h2" color="secondary" mb="50px" style={{ textAlign: 'center' ,fontFamily:"Verdana"}}>
